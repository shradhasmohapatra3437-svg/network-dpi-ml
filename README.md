...
- Blocks traffic matching a configurable **blocked sites list** (`config.json`)
- Exports results to `data/packets.json` after every packet
- **Live web dashboard** — opens in browser, auto-updates every 2 seconds
...
Double-click `dashboard.html` in the project folder. It updates automatically every 2 seconds.
